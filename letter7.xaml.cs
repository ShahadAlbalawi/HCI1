...
namespace ArabicAlphabet
{
    ...
    /// </summary>
    public sealed partial class letter7 : Page
    {
        public letter7()
        {
        ...
        private void letter7soundbutten_Click(object sender, RoutedEventArgs e)
        {
            playaudio("Assets/sound/Khaa.wav");
        }

        private void example1_Click(object sender, RoutedEventArgs e)
        {
            playaudio("Assets/sound/Kharoof.wav");
        }
        private void example2_Click(object sender, RoutedEventArgs e)
        {
            playaudio("Assets/sound/nakhla.wav");
        }
        private void example3_Click(object sender, RoutedEventArgs e)
        {
            playaudio("Assets/sound/sarokh.wav");
        }
