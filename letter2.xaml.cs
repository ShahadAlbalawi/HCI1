...
namespace ArabicAlphabet
{
    ...
    /// </summary>
    public sealed partial class letter2 : Page
    {
        public letter2()
        {
        ...
        private void letter2soundbutten_Click(object sender, RoutedEventArgs e)
        {
            playaudio("Assets/sound/baa.wav");
        }

        private void example1_Click(object sender, RoutedEventArgs e)
        {
            playaudio("Assets/sound/batta.wav");
        }
        private void example2_Click(object sender, RoutedEventArgs e)
        {
            playaudio("Assets/sound/tabeb.wav");
        }
        private void example3_Click(object sender, RoutedEventArgs e)
        {
            playaudio("Assets/sound/dob.wav");
        }
